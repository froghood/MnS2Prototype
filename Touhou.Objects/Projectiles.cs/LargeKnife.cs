...
public class LargeKnife : TimestopProjectile {
    ...
    public LargeKnife(Vector2 origin, float direction, float velocity, bool doesStartFrozen, bool isP1Owned, bool isPlayerOwned, bool isRemote) : base(origin, direction, doesStartFrozen, isP1Owned, isPlayerOwned, isRemote) {
