...
public partial class Marisa : Character {
    ...
    private class SecondaryLvl1 : Attack<Marisa> {
        ...
        public SecondaryLvl1(Marisa c) : base(c) {
            IsHoldable = true;
        }
        ...
        public override void LocalRelease(Time cooldownOverflow, Time heldTime, bool focused) {
            ...
            C.ApplyAbilityLock(Time.InSeconds(0.6f) - refundTime - cooldownOverflow, PlayerActions.Primary);
            C.ApplyAbilityLock(Time.InSeconds(1f) - refundTime - cooldownOverflow, PlayerActions.Secondary);
            C.ApplyAbilityLock(Time.InSeconds(0.2f),
                PlayerActions.Special,
                PlayerActions.Charge
            );
