...
public class Graph : Entity {
    ...
    public override void Render() {
        ...
        foreach (var graph in graphs.Values) {
            ...
            for (int i = 0; i < graph.Samples.Count; i++) {
                vertexArray[i] = new Vertex(new Vector2f(
    ...
    // public Color LineColor { get => _line.FillColor; set => _line.FillColor = value; }
    ...
    //             Position + new Vector2f(Size.X / (SampleCount - 1) * i, Size.Y - n / MaxSample * Size.Y),
    //             LineColor
    //         ));
    //         i++;
    //     }
