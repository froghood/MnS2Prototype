...
public class PacketOld {
    ...
    public PacketOld(PacketType type) {
        this.type = type;
    ...
    public PacketOld In(byte[] data, int offset, int count) {
    ...
    public PacketOld In<T>(T data) where T : struct {
    ...
    public PacketOld Out<T>(out T data, bool fromStart = false) where T : struct {
