...
//     public static TSceneManager TScenes { get => TSceneManager; }
...
//     private static TSceneManager TSceneManager = new();
...
//         inputManager.ActionPressed += (actionData) => TSceneManager.Current.Press(actionData);
//         inputManager.ActionReleased += (action) => TSceneManager.Current.Release(action);

//         network.PacketReceived += (packet, endPoint) => TSceneManager.Current.Receive(packet, endPoint);
...
//             (arg switch {
//                 "-h" => () => TScenes.ChangeTScene<HostingTScene>(),
//                 "-c" => () => TScenes.ChangeTScene<ConnectingTScene>(),
//                 "-t" => () => TScenes.ChangeTScene<OpenGLTesTScene>(),
//                 _ => (Action)(() => TScenes.ChangeTScene<MainTScene>())
//             })();
//         }
...
//         TSceneManager.Current.Render();
//         renderer.Render();
//     }

//     private static void PostRender() {
//         TSceneManager.Current.PostRender();
//     }
